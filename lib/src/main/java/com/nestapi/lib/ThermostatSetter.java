...
public final class ThermostatSetter {
    ...
    /**
     * Sets the desired temperature, in full degrees Fahrenheit (1°F). Used when hvac_mode = "heat"
     * or "cool".
     *
    ...
    /**
     * Sets the desired temperature, in half degrees Celsius (0.5°C). Used when hvac_mode = "heat"
     * or "cool".
     *
     * @param thermostatId The unique identifier for the {@link Thermostat}.
     * @param temperature  The desired temperature, in half degrees Celsius (0.5°C).
     * @param callback     A {@link Callback} to receive whether the change was successful.
     */
    ...
    /**
     * Sets the minimum target temperature, displayed in whole degrees Fahrenheit (1°F). Used when
    ...
    /**
     * Sets the minimum target temperature, displayed in half degrees Celsius (0.5°C). Used when
     * hvac_mode = "heat-cool" (Heat • Cool mode).
     *
     * @param thermostatId The unique identifier for the {@link Thermostat}.
    ...
    /**
     * Sets the maximum target temperature, displayed in whole degrees Fahrenheit (1°F). Used when
     * hvac_mode = "heat-cool" (Heat • Cool mode).
     *
     * @param thermostatId The unique identifier for the {@link Thermostat}.
    ...
    /**
     * Sets the maximum target temperature, displayed in half degrees Celsius (0.5°C). Used when
     * hvac_mode = "heat-cool" (Heat • Cool mode).
     *
     * @param thermostatId The unique identifier for the {@link Thermostat}.
